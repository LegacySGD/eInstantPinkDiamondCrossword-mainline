...
public class PinkDiamondCrosswordWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PinkDiamondCrosswordWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordIW/InitOutcome.xml").getDocumentElement();
